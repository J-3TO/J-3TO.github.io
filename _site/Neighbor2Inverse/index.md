...
<div class="page-container">
  ...
  <div class="grid-description">
    <h3>Overview of the Neighbor2Inverse method</h3>
      <b>A - Neighbor2Neighbor approach in projection space. B - Neighbor2Inverse framework: Subsampling in projection space and denoising in reconstruction space. C - Neighbor2Inverse with data fidelity: Introducing data fidelity terms to constrict the denoising process.</b>
  ...
  <div class="grid-description">
    <h3 style="margin-bottom: 8px;">Comparison of denoising methods on reconstructed CT slices</h3>
    <b>Drag each slider to reveal the Low dose (15ms) image.</b>
  </div>

  <div class="comp-methods-updated-grid">
    <!-- Cells will be filled by JS -->
  </div>

  <div class="comp-methods-inner-divider"></div>

  <div class="comp-methods-updated-grid" id="comp-methods-updated-grid-2">
    <!-- Cells will be filled by JS -->
  </div>
